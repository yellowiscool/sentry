...
GUIDES = {
    ...
    'alert_reminder_1': {
        ...
        'steps': [
            {
                'title': _('Alert Rules'),
                'message': _('You sent ${numEvents} events in the last 30 days but haven\'t customized '
                             'your alerts. Customizing alerts gives you more control over how you get '
                             'notified of issues. Learn more <a href="https://sentry.io/_/resources/customer-success/alert-rules/" target="_blank">here</a>.'),
